    ...
    <div class="collapse navbar-collapse" id="navbarMyEvents">
        <div class="navbar">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item active px-2" style="background-color: rgb(170, 170, 170); border-radius: 20px; text-align: center"><a class="nav-link" href="#" ><strong>Joined</strong></a></li>
